...
/**
 * Kotlin wrapper class for easier usage with cinterop
 */
class ZigSystem {
    companion object {
 ...
 */
fun main() {
    println("🚀 Kotlin-Zig Integration Demo (CInterop)")
    println("==========================================")
    ...
    // Test logging
    println("\n4. Logging Test:")
    system.logInfo("Hello from Kotlin with CInterop!")
    ...
    println("✅ Kotlin-Zig integration is working perfectly with CInterop!")
}
